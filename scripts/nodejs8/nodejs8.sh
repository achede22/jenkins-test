...
f_compilar ()
{
	...
	f_muestra "---------------------------------------------------------- Versiones de Software ORIGINAL "
	...
	f_muestra "---------------------------------------------------------- Versiones de Software (npm UPDATED)"
        ...
        /home/jenkins/.npm-global/lib/node_modules/npm --version
        /home/jenkins/.npm-global/lib/node_modules/npminstall --verbose
